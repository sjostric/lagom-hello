package com.sjostric.hello.impl;
...
import com.sjostric.hello.api.GreetingMessage;
import com.sjostric.hello.api.HelloService;
import com.sjostric.hello.impl.HelloCommand.*;
...
public class HelloServiceImpl implements HelloService {
  ...
  @Override
  public Topic<com.sjostric.hello.api.HelloEvent> helloEvents() {
    ...
    return TopicProducer.taggedStreamWithOffset(HelloEvent.TAG.allTags(), (tag, offset) ->
      ...
      com.sjostric.hello.api.HelloEvent eventToPublish;
      ...
      if (eventAndOffset.first() instanceof HelloEvent.GreetingMessageChanged) {
        ...
        eventToPublish = new com.sjostric.hello.api.HelloEvent.GreetingMessageChanged(
